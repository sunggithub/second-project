...
public class CateItem extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        productView1 = findViewById(R.id.recyclerView5);
        ...
        productList_hair.add(new Product("WALNUT FACE SCRUB","Kylie Skin","505615","Gently exfoliates, helps remove dead skin cells and refine skins texture. Walnut Powder and a Botanical Blend of Fruit Extracts: Help to gently smooth skin. Squalane and Sodium Hyaluronate: Moisturizing agents that help reinforce the skin’s natural moisture.","4/5 (2103 đánh giá)",R.drawable.product_11,R.drawable.product_11));
    ...
    private void setproductRecycler(List<Product> productsDataList) {
        ...
        productView1.setLayoutManager(layoutManager);
        productAdapter1 = new ProductAdapter(this.getContext(),productsDataList);
        productView1.setAdapter(productAdapter1);
    }
